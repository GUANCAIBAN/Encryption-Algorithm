...
// 这是个使用table 直接替换的base64 decode
// there are 64 characters 替换这个即可
static const std::string base64_chars =
"ABCDEFGHIJKLMNOPQRSTUVWXYZ"
"abcdefghijklmnopqrstuvwxyz"
"0123456789+/";

//static const std::string base64_chars = "AEFG014HILM23UDVnopXYZabsqWtuvJKwxycdBCef/glmrz567NOPQRST89+hijk";
...
int main() {
	std::string a = "qHI6u4LBUHLKnC1cWPn63HLKuHI6v4Zc";
	std::string decoded = base64_decode(a);
